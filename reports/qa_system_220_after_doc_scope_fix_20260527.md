...
| --- | --- | ---: |
| retrieval | cases | 188 |
| retrieval | recall_at_3 | 0.707 |
| retrieval | recall_at_5 | 0.766 |
| retrieval | recall_at_8 | 0.793 |
| retrieval | mrr_at_3 | 0.623 |
| retrieval | mrr_at_5 | 0.637 |
| retrieval | mrr_at_8 | 0.641 |
| retrieval | ndcg_at_5 | 0.667 |
| retrieval | forbidden_hit_rate | 0.000 |
| retrieval | plan_accuracy | 0.936 |
| no_answer | cases | 30 |
...
| --- | ---: | --- |
| Recall@5 >= 0.95 | 0.766 | FAIL |
| MRR@5 >= 0.85 | 0.637 | FAIL |
...
| Condition Type Accuracy >= 0.90 | 0.980 | PASS |
| Stream/Final Consistency >= 0.98 | 1.000 | PASS |
| Evidence-backed Change Rate >= 0.90 | 1.000 | PASS |
