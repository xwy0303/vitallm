...
def compact_actual(endpoint_result: EndpointResult) -> Dict[str, Any]:
    return {
        ...
        "query_plan": endpoint_result.query_plan.model_dump(mode="json") if endpoint_result.query_plan else None,
        "hits": [
            {
                "rank": index,
                "document_id": hit.document_id,
                ...
                "text_preview": (hit.text or hit.source_chunk_text or "")[:240],
